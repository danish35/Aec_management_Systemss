...
public class Assignment_Activity extends AppCompatActivity {
    ...
    private EditText txtPdf;
    private ImageView txtAssign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignment_);

        txtPdf=(EditText)findViewById(R.id.txtPdf);
    ...
    private void uploadPDFFile(Uri data) {
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                uploadPDF uploadPDF= new uploadPDF(txtPdf.getText().toString(),url.toString());
                databaseReference.child(databaseReference.push().getKey()).setValue("upload PDF");
                Toast.makeText(Assignment_Activity.this, "File Uploaded Successfully", Toast.LENGTH_SHORT).show();
